 ...
 * @author Daniel
 */
public class PiedraAzul extends CostaAzul {
    protected int habitacionesDoblesOcupadas1;
    protected int habitacionesDoblesDisponibles1 = 25;
    protected int habitacionesCuadruplesOcupadas1;
    protected int habitacionesCuadruplesDesocupadas1 = 25;
    protected int totalHabitaciones1 = 50;
    protected int totalHabitacionesOcupadas1;
    protected int totalHabitacionesDisponibles1 = 50;
    protected int montoDeIngreso1;
    protected String nombreHotel = "Piedra Blanca";

    public PiedraAzul(int habitacionesCuadruplesOcupadas, int habitacionesDoblesOcupadas, int totalHabitacionesOcupadas) {
    ...
    public void doble(int personas) {
        ...
        System.out.println("Usted debe de pagar " + (150000*personas));
        System.out.println("------------------------------------------------------");
        mostrarGeneral();
        System.out.println("------------------------------------------------------");
    ...
    public void cuadruple(int personas) {
        ...
        System.out.println("Usted debe de pagar " + (450000*personas));
        System.out.println("------------------------------------------------------");
        mostrarGeneral();
        System.out.println("------------------------------------------------------");
        mostrarGeneralPiedraBlanca();
